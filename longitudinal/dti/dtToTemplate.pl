...
my $mniTemplateOutputSuffix = "NormalizedToMNI152";
...
# get to MNI 152 if standardTemplate is "/data/grossman/pipedream2018/templates/OASIS/T_template0.nii.gz"
my $templateCheck = "/data/grossman/pipedream2018/templates/OASIS/T_template0.nii.gz";
if ($standardTemplate eq $templateCheck ) {
    print "\nCreating output in MNI152 space \n";
    
    my $dtMNITemplate = "${outputRoot}DT${mniTemplateOutputSuffix}.nii.gz";

    my $mniTemplateWarpString = " -t /data/grossman/pipedream2018/templates/OASIS/MNI152/T_template0_ToMNI1521Warp.nii.gz -t /data/grossman/pipedream2018/templates/OASIS/MNI152/T_template0_ToMNI1520GenericAffine.mat ";

    my $mniTemplate = "/data/grossman/pipedream2018/templates/OASIS/MNI152/MNI152_T1_1mm_brain.nii.gz"; 

    my $mniTemplateMask = "/data/grossman/pipedream2018/templates/OASIS/MNI152/MNI152_T1_1mm_brainMask.nii.gz"; 

    warpAndReorientDT($dtMoving, $mniTemplate, "$mniTemplateWarpString $standardTemplateWarpString $templateWarpString $distCorrWarpString", $mniTemplateMask, $backgroundMD, $dtMNITemplate);

    createScalarImages($dtMNITemplate, $outputRoot, $mniTemplateOutputSuffix);
}
